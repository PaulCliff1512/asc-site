            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item active" href="widnes.php">Widnes</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<section class="py-5 bg-dark text-white">
    <div class="container text-center">
        <h2 class="fw-bold mb-3">MOT Price Widnes Auto Safety Centre from £34.99</h2>
        <p class="lead mb-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="service-card">
                    ...
                    <p><strong>Phone:</strong> <a href="tel:01515320201">0151 532 0201</a></p>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Why Choose Auto Safety Centre Widnes?</h2>
        <ul class="list-unstyled text-center">
            <li>✔ DVSA-approved MOT centre serving all WA8 areas</li>
            <li>✔ Convenient location close to Widnes town centre and Runcorn Bridge</li>
            <li>✔ Easy access from A557, A562 and surrounding Halton areas</li>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-5">Services Available at Our Widnes Depot</h2>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Meet the Widnes Team</h2>
        <div class="row text-center">

            <div class="col-md-4">
                <h5 class="fw-bold">Dave</h5>
                <p>Senior MOT Tester – DVSA-approved with extensive experience.</p>
            </div>

            <div class="col-md-4">
                <h5 class="fw-bold">Lewis</h5>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <?php 
           ...
           asc_render_reviews_block('widnes');
        ?>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="assets/send.php" method="POST">
                    ...
                    <input type="hidden" name="depot" value="widnes">
...
<div class="d-lg-none position-fixed bottom-0 start-0 end-0 bg-dark text-white text-center py-2" style="z-index:9999;">
    <a href="tel:+441515320201" class="text-white fw-bold" style="font-size:1.2rem;">
        Call Us: 0151 532 0201
    </a>
</div>
