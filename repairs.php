...
<section class="py-5 bg-light">
    <div class="container">
        <h2 class="fw-bold text-center mb-5">Our Repair Services</h2>

        <div class="row g-4">

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Brakes</h4><p>Brake pads, discs, calipers, ABS faults and hydraulic issues diagnosed and repaired.</p></div></div>

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Suspension</h4><p>Shocks, springs, control arms, bushes and steering components replaced and aligned.</p></div></div>

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Diagnostics</h4><p>Full engine diagnostics using advanced equipment to identify faults quickly and accurately.</p></div></div>

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Exhausts</h4><p>Exhaust repairs, replacements, emissions checks and catalytic converter issues resolved.</p></div></div>

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Clutches & Gearboxes</h4><p>Clutch replacements, gearbox repairs and transmission diagnostics for all vehicle types.</p></div></div>

            <div class="col-md-4"><div class="service-card"><h4 class="fw-bold">Batteries</h4><p>Battery testing, replacement and charging system diagnostics to keep you moving.</p></div></div>
