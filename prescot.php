...
<head>
    ...
    <!-- SCHEMA: AutoRepair + FAQ + Social Proof -->
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item active" href="prescot.php">Prescot</a></li>
...
<section class="py-5 bg-dark text-white">
    <div class="container text-center">
        <h2 class="fw-bold mb-3">MOT Price Prescot Auto Safety Centre from £34.99</h2>
        <p class="lead mb-4">
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Why Choose Auto Safety Centre Prescot?</h2>
        <ul class="list-unstyled text-center">
            <li>✔ DVSA-approved MOT centre serving all L34 areas</li>
            <li>✔ Convenient location close to Prescot Retail Park and Whiston Hospital</li>
            <li>✔ Easy access from M57, A58 and A57 for drivers within 5 miles</li>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-5">Services Available at Our Prescot Depot</h2>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Meet the Prescot Team</h2>
        <div class="row text-center">

            <div class="col-md-4">
                <h5 class="fw-bold">Alan</h5>
                <p>Senior MOT Tester – DVSA-approved with extensive experience.</p>
            </div>

            <div class="col-md-4">
                <h5 class="fw-bold">Chris</h5>
                <p>Vehicle Technician – specialising in diagnostics and repairs.</p>
            </div>

            <div class="col-md-4">
                <h5 class="fw-bold">Lisa</h5>
                <p>Service Advisor – helping customers with bookings and enquiries.</p>
            </div>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <?php 
           ...
           asc_render_reviews_block('prescot');
        ?>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="assets/send.php" method="POST">
                    ...
                    <input type="hidden" name="depot" value="prescot">
...
<div class="d-lg-none position-fixed bottom-0 start-0 end-0 bg-dark text-white text-center py-2" style="z-index:9999;">
    <a href="tel:+441515320532" class="text-white fw-bold" style="font-size:1.2rem;">
        Call Us: 0151 532 0532
    </a>
</div>
