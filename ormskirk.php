            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item active" href="ormskirk.php">Ormskirk</a></li>
...
<section class="py-5 bg-dark text-white">
    <div class="container text-center">
        <h2 class="fw-bold mb-3">MOT Price Ormskirk Auto Safety Centre from £34.99</h2>
        <p class="lead mb-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="service-card">
                    ...
                    <p><strong>Phone:</strong> <a href="tel:01695310106">01695 310106</a></p>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Why Choose Auto Safety Centre Ormskirk?</h2>
        <ul class="list-unstyled text-center">
            <li>✔ DVSA-approved MOT centre serving all L39 areas</li>
            <li>✔ Convenient location close to Ormskirk town centre and Edge Hill University</li>
            <li>✔ Easy access from A570, A59 and surrounding West Lancashire villages</li>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-5">Services Available at Our Ormskirk Depot</h2>
...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bold text-center mb-4">Meet the Ormskirk Team</h2>
        <div class="row text-center">

            <div class="col-md-4">
                <h5 class="fw-bold">Mark</h5>
                <p>Senior MOT Tester – DVSA-approved with extensive experience.</p>
            </div>

            <div class="col-md-4">
                <h5 class="fw-bold">Tom</h5>
                <p>Vehicle Technician – specialising in diagnostics and repairs.</p>
            </div>

            <div class="col-md-4">
                <h5 class="fw-bold">Emily</h5>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <?php 
           ...
           asc_render_reviews_block('ormskirk');
        ?>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="assets/send.php" method="POST">
                    ...
                    <input type="hidden" name="depot" value="ormskirk">
...
<div class="d-lg-none position-fixed bottom-0 start-0 end-0 bg-dark text-white text-center py-2" style="z-index:9999;">
    <a href="tel:+441695310106" class="text-white fw-bold" style="font-size:1.2rem;">
        Call Us: 01695 310106
    </a>
</div>
